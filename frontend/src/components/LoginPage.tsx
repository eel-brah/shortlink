        ...
        <div className="max-w-5xl w-full h-auto md:h-[min(700px,80%)] grid grid-cols-1 md:grid-cols-2 rounded-2xl md:rounded-3xl overflow-hidden border border-gray-100 shadow-[0px_30px_80px_rgba(0,0,0,0.08)] bg-white">
          ...
          <div className="hidden md:flex relative bg-[#3f47b2] text-white p-10 lg:p-12 flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-lg font-semibold mb-8 lg:mb-12 opacity-90">ShortLink</h2>
              <h1 className="text-3xl lg:text-4xl font-extrabold leading-tight mb-6">
                Architecting your digital <br /> traffic flow.
              </h1>
              <p className="text-indigo-100/80 text-sm lg:text-base leading-relaxed max-w-sm">
                Access your workspace to monitor, optimize, and scale your brand’s connectivity.
              </p>
            </div>

            <div className="relative z-10 flex items-center gap-4 text-[10px] font-semibold text-white/50 tracking-[0.2em] mt-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition"
              ...
              <div>
                <div className="flex justify-between text-[10px] sm:text-xs font-bold text-gray-400 uppercase tracking-wider px-1">
                  <span>Password</span>
                  <span className="text-indigo-600 cursor-pointer hover:underline normal-case font-medium">Forgot?</span>
                </div>
                <input
                  type="password"
                  value={password}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-indigo-600 text-white py-3.5 rounded-xl font-semibold text-sm sm:text-base shadow-md hover:shadow-lg hover:bg-indigo-700 active:scale-95 transition-all flex justify-center items-center"
              >
